  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-bold">Borçlar Yönetimi</h2>
      </div>
      
      <Tabs defaultValue="supplier" value={activeTab} onValueChange={(value) => setActiveTab(value as "supplier" | "customer")}> 
        <TabsList className="w-full grid grid-cols-2">
          <TabsTrigger value="supplier">Tedarikçi Borçlar</TabsTrigger>
          <TabsTrigger value="customer">Müşteri Borçlar</TabsTrigger>
        </TabsList>
    ...
    <div className="container mx-auto py-6">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div>
            <CardTitle className="text-2xl font-bold">Borçlar Yönetimi</CardTitle>
            <CardDescription>
